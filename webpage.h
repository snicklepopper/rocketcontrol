const char webpage_gz[] PROGMEM = "<!DOCTYPE html>\n"
"<html lang=\"en\">\n"
"  <head>\n"
...
"          <input type=\"range\" id=\"volume\" name=\"volume\" class=\"slidercontrol\" min=\"0\" max=\"100\" value=\"0\" disabled onChange=\"talk(name, value)\">\n"
"          <label for=\"volume\" class=\"sliderlabel\">Volume</label>\n"
"        </div>\n"
"        <div id=\"slider2\" class=\"slider\">\n"
"          <input type=\"range\" id=\"cowbell\" name=\"cowbell\" class=\"slidercontrol\" min=\"0\" max=\"100\" value=\"0\" disabled onChange=\"talk(name, value)\">\n"
...
"  document.getElementById(\"switch\").checked = (m.data == \"true\");\n"
...
"  //document.getElementById(\"cowbell\").onchange();\n"
"});\n"
"\n"
"evtSource.addEventListener(\"gravity\", function(m) {\n"
"  var gravity = parseFloat(m.data);\n"
